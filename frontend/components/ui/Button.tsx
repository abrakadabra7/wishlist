...
const variants: Record<Variant, string> = {
  primary:
    "bg-brand-600 text-white hover:bg-brand-700 active:bg-brand-800 shadow-soft hover:shadow-card-hover transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]",
  secondary:
    "bg-surface-100 text-surface-800 hover:bg-surface-200 active:bg-surface-300 border border-surface-200/80 transition-all duration-200",
  ghost:
    "bg-transparent text-surface-700 hover:bg-surface-100 active:bg-surface-200 transition-colors duration-200",
  danger:
    "bg-red-600 text-white hover:bg-red-700 active:bg-red-800 transition-all duration-200",
  fancy: "btn-fancy",
};
