...
const variants: Record<Variant, string> = {
  ...
  secondary:
    "bg-surface-100 text-surface-800 dark:bg-surface-700 dark:text-surface-200 hover:bg-surface-200 dark:hover:bg-surface-600 active:bg-surface-300 dark:active:bg-surface-500 border border-surface-200/80 dark:border-surface-600 transition-all duration-200",
  ghost:
    "bg-transparent text-surface-700 dark:text-surface-300 hover:bg-surface-100 dark:hover:bg-surface-800 active:bg-surface-200 dark:active:bg-surface-700 transition-colors duration-200",
  danger:
